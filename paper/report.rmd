...
$$EM = \frac{D_{w, y}}{\overline{D_{w, y-5, y}}}$$
...
$$EM = \frac{D_{w, y}}{\frac{1}{n} \sum^{n}_{k=1} D_{w, y-k}}$$
...
The *cumulative mortality rate* represents the ratio between the sum of all deaths between the first week of a year or years up to a user-defined week, where weeks must be $1 \leq w \leq 52$.
...
The ratio is computed for a single year $y$ and up to week $s$ as follows:

$$CMR = \frac{\sum^{s}_{w=1} D_{w, y}}{P_{w, y}}$$
