...
In order to query the Eurostat API, we have to use the [Eurostat Query Builder](https://ec.europa.eu/eurostat/web/json-and-unicode-web-services/getting-started/query-builder). 
