...
- [**Python**](https://www.python.org/) is general purpose object-oriented programming language used within this project for the entirety of the data querying, pre-processing and updating. 
