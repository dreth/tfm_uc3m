...
5. A [```to_keep```](https://github.com/dreth/tfm_uc3m/blob/report_ref/api/functions.py#L467) object is created filtering only elements in the current dataset that are
