...
- **Controls**: The parameters that can be modified for the plot are the following:
    ...
    + *Selection of year range* to plot. This is a discrete slider, so any range of years between 2010 and 2021 can be selected. As more data is added in the future, both the week and year slider should increase.
