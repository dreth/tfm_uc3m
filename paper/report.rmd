...
## Dataset update methodology after pre-processing
...
- [**dbs_check.py**](https://github.com/dreth/tfm_uc3m/blob/report_ref/api/dbs_check.py): is a script ran first at the application's runtime

## Appendix B: R

## Appendix C: Docker

## Appendix D: Project repository tree structure
