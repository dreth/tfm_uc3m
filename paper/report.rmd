...
The application allows for active, real-time monitoring of mortality and life expectancy of the population of Spain, through an [open-source](https://github.com/dreth/tfm_uc3m) shiny web-based dashboard.
...
As an open source project, we intend to make it a public good, and anyone can do whatever they want with the original source code as long as they abide to a license. This project is licensed under the [GNU General Public License V3](https://www.gnu.org/licenses/gpl-3.0.en.html).
